...
#ifdef ZKHD_HAWK_beep__LED_ENABLE
void Hardware_LED_beep_1_ON(void);
void Hardware_LED_beep_1_OFF(void);
void Hardware_LED_beep_1_TOGGLE(void);
void Hardware_LED_beep_2_ON(void);
void Hardware_LED_beep_2_OFF(void);
void Hardware_LED_beep_2_TOGGLE(void);
void Hardware_LED_beep_3_ON(void);
void Hardware_LED_beep_3_OFF(void);
void Hardware_LED_beep_3_TOGGLE(void);
void Hardware_LED_beep_4_ON(void);
void Hardware_LED_beep_4_OFF(void);
void Hardware_LED_beep_4_TOGGLE(void);
#endif
