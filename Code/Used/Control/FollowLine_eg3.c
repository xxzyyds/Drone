...
void Follow_Init()
{
    ...
    for(int i=0;i<=11;i++)
    {
        if(((OpenMVFrame_t *)UsartGroup[UART_A3].RxBuff+i)->Start == 0xAAAA) && ((OpenMVFrame_t *)UsartGroup[UART_A3].RxBuff+i)->End == 0x5555))
            FollowManager.ptrFrame = (OpenMVFrame_t *)UsartGroup[UART_A3].RxBuff+i;
    }
